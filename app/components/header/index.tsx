...
const Navbar = () => {
    ...
    return (
        <>
            {/* Desktop Navbar */}
            <div className={`fixed right-0 left-0 z-20 transition-all duration-300 ${isScrolled ? "bg-white dark:bg-[#222222] shadow" : "bg-transparent"}`}>
            ...
            {isMobileNavOpen && (
                <div className=" bg-white dark:bg-[#222222] fixed h-full w-80 z-30 top-0 left-0 lg:hidden shadow-lg transition-all duration-300">
                    <nav className="p-6 flex flex-col h-full justify-between">
                        ...
                        <button className="flex items-center justify-between p-4 rounded-full text-black font-semibold bg-[#64ec9d]">
                            Let&apos;s Talk <FiArrowUpRight />
                        </button>
                    </nav>
                </div>
