    ...
    return (
        <section className="p-32 px-3 md:px-5 bg-[#faf7f2]">
            <div className="flex flex-col lg:flex-row max-w-[80rem] mx-auto items-center gap-6 pt-16">
                <div className="h-[40rem]  space-y-5 flex flex-col bg-white rounded-xl lg:p-12 p-6 flex-1">
                    ...
                    <div className="space-y-6 max-w-[30rem]">
                        ...
                        <div className="grid lg:grid-cols-2 gap-6">
                            <span className="flex items-center gap-3 text-[20px]"> <FiFacebook size={50} className="bg-[#faf7f2] p-4 rounded-full" /> Facebook </span>
                            <span className="flex items-center gap-3 text-[20px]"> <FiFacebook size={50} className="bg-[#faf7f2] p-4 rounded-full" /> Facebook </span>
                            <span className="flex items-center gap-3 text-[20px]"> <FiFacebook size={50} className="bg-[#faf7f2] p-4 rounded-full" /> Facebook </span>
                            <span className="flex items-center gap-3 text-[20px]"> <FiFacebook size={50} className="bg-[#faf7f2] p-4 rounded-full" /> Facebook </span>
                        </div>
                ...
                <div className=" h-[40rem] w-full space-y-5 flex flex-col bg-white rounded-xl lg:p-12 p-6 flex-1">
                    <form action="" className="space-y-6 ">
                        <div className="flex flex-col gap-2 relative">
                            <label className="text-[18px]">Name</label>
                            <input type="text" className="w-full bg-[#faf7f2] border-none rounded-full py-4 px-10" placeholder="full name" />
                            <CiUser size={25} className="absolute bottom-4 left-4 text-gray-300" />
                        </div>
                        <div className="flex flex-col gap-3 relative">
                            <label className="text-[18px]">Email</label>
                            <input type="email" className="w-full bg-[#faf7f2] border-none rounded-full py-4 px-10" placeholder="full name" />
                            <CiUser size={25} className="absolute bottom-4 left-4 text-gray-300" />
                        </div>
                        <div className="flex flex-col gap-3 relative">
                            <label className="text-[18px]">Number</label>
                            <input type="number" className="w-full bg-[#faf7f2] border-none rounded-full py-4 px-10" placeholder="full name" />
                            <CiUser size={25} className="absolute bottom-4 left-4 text-gray-300" />
                        </div>
                        <div className="flex flex-col gap-3 relative">
                            <label className="text-[18px]">Additional info</label>
                            <input type="text" className="w-full bg-[#faf7f2] border-none rounded-lg py-8 px-10" placeholder="full name" />
